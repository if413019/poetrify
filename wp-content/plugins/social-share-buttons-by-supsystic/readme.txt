...
Simple [social share solution](http://supsystic.com/plugins/social-share-plugin/ "Social Share Buttons plugin by Supsystic") with custom buttons design and placement. Choose any social network (Facebook, Twitter, Pinterest, Google+, LinkdIn etc.), button design and share bare location. Save your project and that's it.
Simple, eye-catching social sharing plugin with great customization and tons of features:
